...
import { ChevronLeft, ChevronRight, NotepadText, Plus, Search, X } from 'lucide-react';
...
const medicines = [
  ...
  { rubric: "Abdomen, heat, extending, head", remedies: "Alum., Carbn-o., Indg., Kali-c., Lyc., Mag-m., Nat-s., Plb., Sumb.", selected: true },
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] flex flex-col">
        ...
        <div className="flex justify-between text-sm my-2">
          <div className="space-x-2">
            ...
            <Button variant="ghost" className="text-muted-foreground p-0">Selected (1)</Button>
          </div>
        </div>
        ...
        <ScrollArea className="flex-grow">
          <Table>
            ...
            {medicines.map((medicine, index) => (
                <TableRow key={index} className={medicine.selected ? "bg-primary/10" : ""}>
